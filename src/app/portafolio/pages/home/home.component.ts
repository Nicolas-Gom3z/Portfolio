...
export class HomeComponent {
  ...
  cards:PortafolioCard[] = [
...

    {
      ...
      "summary":"Tienda que ofrece joyas, piedras preciosas y semipreciosas. Este proyecto se comienza con una estructura ya establecida por el cliente, el objetivo fue implementar pasarela de pagos y personalizar el flujo de compra. Así mismo, se brinda asesoría sobre el funcionamiento de WooCommerce y sus características para que el cliente sea capaz de administrar la tienda.",
